...
populate udac appsettings with values:
  file.managed:
    - name: {{ base.udac_appsettings_location }}
    - source: salt://{{base.templates_folder}}/{{ base.udac_appsettings }}
    - template: jinja

populate webhooks appsettings with values:
  file.managed:
    - name: {{ base.webhook_appsettings_location }}
    - source: salt://{{base.templates_folder}}/{{ base.webhook_appsettings }}
    - template: jinja
