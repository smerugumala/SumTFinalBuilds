...
####  REMEDIATE POLICY  ####
#client.api.sec.remediate_policy(policy_uuid=get_policy())

####  CLEANUP  ####
#client.api.sec.delete_policy(policy_uuid=get_policy())
#client.api.tgt.delete_target_group(tgt_uuid=get_target())